...
namespace MailSender.Reports
{
    public class Report
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00377F46", RsidParagraphAddition = "00EF531F", RsidRunAdditionDefault = "00E1086F" };

            ParagraphProperties paragraphProperties1 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties1 = new ParagraphMarkRunProperties();
            Bold bold1 = new Bold();
            Color color1 = new Color() { Val = "548DD4", ThemeColor = ThemeColorValues.Text2, ThemeTint = "99" };
            ...
            Bold bold2 = new Bold();
            Color color2 = new Color() { Val = "548DD4", ThemeColor = ThemeColorValues.Text2, ThemeTint = "99" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "00E118FC", RsidParagraphAddition = "00E118FC", RsidRunAdditionDefault = "00E1086F" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00E118FC", RsidR = "00E118FC" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "0052462E" };
            Rsid rsid1 = new Rsid() { Val = "00336347" };
            Rsid rsid2 = new Rsid() { Val = "00377F46" };
            Rsid rsid3 = new Rsid() { Val = "0052462E" };
            Rsid rsid4 = new Rsid() { Val = "00E02B4C" };
            Rsid rsid5 = new Rsid() { Val = "00E1086F" };
            Rsid rsid6 = new Rsid() { Val = "00E118FC" };
            Rsid rsid7 = new Rsid() { Val = "00EF531F" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Languages languages6 = new Languages() { Val = "ru-RU", EastAsia = "en-US", Bidi = "ar-SA" };
            ...
            runPropertiesBaseStyle2.Append(languages6);
        ...
        {
            document.PackageProperties.Creator = "p12_SvetlakovES";
            document.PackageProperties.Revision = "3";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2019-07-09T09:51:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-07-09T09:53:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "p12_SvetlakovES";
        }
